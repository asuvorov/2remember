...
class ChallengeCreateModelTestCase(TestCase):
    ...
    def setUp(self):
        """Set up."""
        cprint("***" * 27, "green")
        cprint("*** TEST > CHALLENGES > MODELS > CREATE", "green")
    ...
    def test_challenge_defaults(self):
        ...
        cprint("[---  INFO   ---] Challenge create. Defaults...", "cyan")
    ...
    def test_challenge_wo_author(self):
        ...
        cprint("[---  INFO   ---] Challenge create. Without Author...", "cyan")
    ...
    def test_challenge_wo_name(self):
        ...
        cprint("[---  INFO   ---] Challenge create. Without Name...", "cyan")
    ...
    def test_challenge_wo_avatar(self):
        ...
        cprint("[---  INFO   ---] Challenge create. Without Avatar...", "cyan")
    ...
    def test_challenge_w_organization(self):
        ...
        cprint("[---  INFO   ---] Challenge create. With Organization...", "cyan")
...
class ChallengeListViewTestCase(TestCase):
    ...
    def setUp(self):
        """Set up."""
        cprint("***" * 27, "green")
        cprint("*** TEST > CHALLENGES > VIEWS > LIST", "green")
        ...
        # --- Challenges
        self.test_draft_event_11 = Challenge.objects.get(id=211)
        self.test_draft_event_21 = Challenge.objects.get(id=221)

        self.test_upcoming_private_event_12 = Challenge.objects.get(id=212)
        self.test_upcoming_private_event_32 = Challenge.objects.get(id=232)

        self.test_upcoming_public_event_22 = Challenge.objects.get(id=222)
        self.test_upcoming_public_event_42 = Challenge.objects.get(id=242)

        self.test_completed_event_13 = Challenge.objects.get(id=213)
        self.test_completed_event_23 = Challenge.objects.get(id=223)

        self.test_pastdue_event_24 = Challenge.objects.get(id=224)
        self.test_pastdue_event_44 = Challenge.objects.get(id=244)

        self.test_dateless_event_15 = Challenge.objects.get(id=215)
        self.test_dateless_event_25 = Challenge.objects.get(id=225)
    ...
    def test_user_not_logged_in(self):
        ...
        cprint("[---  INFO   ---] Test Challenge List. User NOT logged in...", "cyan")
        ...
        # cprint("[---  DUMP   ---] CONTEXT          : %s" % response.context["challenges"], "yellow")
    ...
    def test_user_logged_in(self):
        ...
        cprint("[---  INFO   ---] Test Challenge List. User logged in. Simple Case...", "cyan")
    ...
    def test_user_logged_in_and_author_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge List. User logged in, and the Author of the private Organization...", "cyan")
    ...
    def test_user_logged_in_and_staff_member_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge List. User logged in, and the Staff Member of the private Organization...", "cyan")
    ...
    def test_user_logged_in_and_group_member_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge List. User logged in, and the Group Member of the private Organization...", "cyan")
    ...
    def test_user_logged_in_and_author_and_staff_member_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge List. User logged in, and Author and the Staff Member of the private Organization...", "cyan")
    ...
    def test_user_logged_in_and_author_and_group_member_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge List. User logged in, and Author the Group Member of the private Organization...", "cyan")
...
class ChallengeCreateViewTestCase(TestCase):
    ...
    def setUp(self):
        """Set up."""
        cprint("***" * 27, "green")
        cprint("*** TEST > CHALLENGES > VIEWS > CREATE", "green")
    ...
    def test_user_not_logged_in(self):
        ...
        cprint("[---  INFO   ---] Test Challenge create. User NOT logged in...", "cyan")
    ...
    def test_user_logged_in(self):
        ...
        cprint("[---  INFO   ---] Test Challenge create. User logged in...", "cyan")
...
class ChallengeDetailsViewTestCase(TestCase):
    ...
    def setUp(self):
        """Set up."""
        cprint("***" * 27, "green")
        cprint("*** TEST > CHALLENGES > VIEWS > DETAILS", "green")
    ...
    def test_user_not_logged_in_event_of_public_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User NOT logged in. Challenge of the public Organization...", "cyan")
    ...
    def test_user_not_logged_in_event_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User NOT logged in. Challenge of the private Organization...", "cyan")
    ...
    def test_user_not_logged_in_event_draft(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User NOT logged in. Challenge Draft...", "cyan")
    ...
    def test_user_not_logged_in_event_completed(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User NOT logged in. Challenge completed...", "cyan")
    ...
    def test_user_not_logged_in_event_pastdue(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User NOT logged in. Challenge past due...", "cyan")
    ...
    def test_user_not_logged_in_event_dateless(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User NOT logged in. Challenge dateless...", "cyan")
    ...
    def test_user_logged_in_event_of_public_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization...", "cyan")
    ...
    def test_user_logged_in_event_of_public_org_waiting(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization. Participation waiting for Confirmation...", "cyan")
        ...
        participation = Participation.objects.create(
            ...
            challenge=self.test_upcoming_public_event_42,
            # role=,
    ...
    def test_user_logged_in_event_of_public_org_confirmed(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization. Participation confirmed...", "cyan")
    ...
    def test_user_logged_in_event_of_public_org_canceled_by_admin(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization. Participation canceled by Admin...", "cyan")
    ...
    def test_user_logged_in_event_of_public_org_canceled_by_user_reenter_allowed(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization. Participation canceled by User. Reenter allowed...", "cyan")
    ...
    def test_user_logged_in_event_of_public_org_canceled_by_user_reenter_not_allowed(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization. Participation canceled by User. Reenter NOT allowed...", "cyan")
        ...
        participation = Participation.objects.create(
            ...
            challenge=self.test_upcoming_public_event_22,
            # role=,
            status=PARTICIPATION_STATUS.CANCELLED_BY_USER,
        )
    ...
    def test_user_logged_in_event_of_public_org_waiting_for_selfreflection(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization. Waiting for Selfreflection...", "cyan")
    ...
    def test_user_logged_in_event_of_public_org_waiting_for_acknowledgment(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization. Waiting for Acknowledgment...", "cyan")
    ...
    def test_user_logged_in_event_of_public_org_acknowledged(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the public Organization. Acknowledged...", "cyan")
    ...
    def test_user_logged_in_event_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge of the Private Organization...", "cyan")
    ...
    def test_user_logged_in_event_draft(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge Draft...", "cyan")
    ...
    def test_user_logged_in_event_completed(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. Challenge completed...", "cyan")
    ...
    def test_user_logged_in_and_author_of_upcoming_chl(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in, and the Author of the upcoming Challenge...", "cyan")
    ...
    def test_user_logged_in_and_staff_member_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in, and the Staff Member of the private Organization...", "cyan")
    ...
    def test_user_logged_in_and_group_member_of_private_org(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in, and the Group Member of the private Organization...", "cyan")
    ...
    def test_user_logged_in_not_subscriber(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. NOT an Organization Subscriber...", "cyan")
    ...
    def test_user_logged_in_subscriber(self):
        ...
        cprint("[---  INFO   ---] Test Challenge Details. User logged in. An Organization Subscriber...", "cyan")
...
class ChallengeCreateFormTestCase(TestCase):
    ...
    def setUp(self):
        """Set up."""
        cprint("***" * 27, "green")
        cprint("*** TEST > CHALLENGES > FORMS > CREATE", "green")
