...
# ===
# =============================================================================
class UploadPrivateViewSetMarkTests(APITestCase):

    """UploadPrivateViewSet (mark as private) Test Class."""
    ...
    def test_not_authenticated(self):
        """Mark Upload as private: User is not authenticated."""
        ...
        url = reverse("api-upload-private", kwargs={
            "upload_type":  "temp",
    ...
    def test_unsupported(self):
        """Mark Upload as private: Unsupported Media Type."""
    ...
    def test_failure(self):
        """Mark Upload as private: Failure."""
        ...
        self.assertFalse(self.tmp_file.is_private)
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertFalse(self.attached_image.is_private)
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertFalse(self.attached_document.is_private)
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertFalse(self.attached_url.is_private)
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertFalse(self.attached_video_url.is_private)

    def test_success(self):
        """Mark Upload as private: Success."""
        ...
        self.assertTrue(self.tmp_file.is_private)
        ...
        self.attached_image.refresh_from_db()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertTrue(self.attached_image.is_private)
        ...
        self.attached_document.refresh_from_db()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertTrue(self.attached_document.is_private)
        ...
        self.attached_url.refresh_from_db()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertTrue(self.attached_url.is_private)
        ...
        self.attached_video_url.refresh_from_db()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertTrue(self.attached_video_url.is_private)


class UploadPrivateViewSetUnmarkTests(APITestCase):

    """UploadPrivateViewSet (unmark as private) Test Class."""
