...
# ===
# =============================================================================
class CollectionPublishTests(APITestCase):

    """CollectionPublish Test Class."""
    ...
    def setUp(self):
        ...
        self.collection = Collection.objects.create(
            author=self.john,
            title="Collection #1")
        self.url = reverse("api-collection-publish", kwargs={
    ...
    def test_not_authenticated(self):
        """Publish Collection: User is not authenticated."""
    ...
    def test_failure(self):
        ...
        url = reverse("api-collection-publish", kwargs={
            "collection_id": 10,
        })
    ...
    def test_success(self):
        ...
        self.assertEqual(self.collection.status, Status.PUBLISHED)
