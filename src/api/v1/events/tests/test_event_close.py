...
# ===
# =============================================================================
class EventCloseViewSetTests(APITestCase):

    """EventCloseViewSet Test Class."""
    ...
    def setUp(self):
        ...
        self.event = Event.objects.create(
            author=self.john,
            title="Event #1")
        self.url = reverse("api-event-close", kwargs={
    ...
    def test_not_authenticated(self):
        """Close Event: User is not authenticated."""
    ...
    def test_failure(self):
        ...
        url = reverse("api-event-close", kwargs={
            "event_id": 10,
        })
    ...
    def test_success(self):
        ...
        self.assertEqual(self.event.status, Status.CLOSED)
