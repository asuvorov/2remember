    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(upload_to=organizations.models.organization_directory_path)),
                ...
                ('alt_person_fullname', models.CharField(blank=True, help_text='Organization contact Person full Name', max_length=80, null=True, verbose_name='Full Name')),
                ('alt_person_email', models.EmailField(blank=True, help_text='Organization contact Person Email', max_length=80, null=True, verbose_name='Email')),
                ('alt_person_phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, help_text='Please, use the International Format, e.g. +1-202-555-0114.', max_length=128, region=None, verbose_name='Phone Number')),
                ...
                ('phone_number', models.ForeignKey(blank=True, help_text='Organization Phone Numbers', null=True, on_delete=django.db.models.deletion.CASCADE, to='ddcore.phone', verbose_name='Phone Numbers')),
            ...
            bases=(models.Model, ddcore.models.Attachment.AttachmentMixin, ddcore.models.Comment.CommentMixin, ddcore.models.Complaint.ComplaintMixin, ddcore.models.Rating.RatingMixin, ddcore.models.View.ViewMixin),
        ),
        migrations.CreateModel(
            ...
            bases=(ddcore.models.Attachment.AttachmentMixin, ddcore.models.Comment.CommentMixin, ddcore.models.Rating.RatingMixin, ddcore.models.View.ViewMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('title', models.CharField(max_length=255, verbose_name='title')),
                ('name', models.CharField(db_index=True, help_text='Organiztion Group Name', max_length=80, verbose_name='Name')),
                ('description', models.TextField(blank=True, help_text='Organization Group Description', null=True, verbose_name='Description')),
            ...
            bases=(models.Model, ddcore.models.Attachment.AttachmentMixin, ddcore.models.Comment.CommentMixin, ddcore.models.Rating.RatingMixin, ddcore.models.View.ViewMixin),
        ),
    ]
